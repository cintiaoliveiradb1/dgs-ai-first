...
- Faixas de peso para frete especial (a partir de 500 kg) e seus fatores multiplicadores
...
- Pausa do relógio de SLA fora do horário comercial (08h–18h, dias úteis) para chamados gerais
...
- Categorias de carga inelegíveis para devolução padrão:
  ...
  - Cargas com lacre de segurança violado (salvo documentação no ato com assinatura de motorista e recebedor)
- Procedimento: abertura no Portal do Cliente, documentos exigidos (CT-e, mínimo 3 fotos, motivo), triagem em 4h úteis, coleta reversa em até 2 dias úteis após aprovação, reembolso em até 5 dias úteis após recebimento no CD
- Devoluções parciais: por volume individual, cálculo proporcional ao peso/valor no CT-e
...
- Relógio contínuo (sem pausa) para incidentes críticos de clientes Gold
...
|---|------|----------------------|-----------|
| C1 | **Conflito** | BC-A1 | PROC-042-v1 e v2 coexistem sem hierarquia formal no SharePoint; multiplicadores regionais, fatores de peso e prazo adicional são distintos entre as versões |
| C2 | **Conflito** | BC-A1 / BC-A5 | FAQ-Item 45 diz "desconto acima de 10 fretes/mês"; PROC-042-v2 diz "a partir de 8 fretes/mês" — valores distintos para o mesmo tema |
